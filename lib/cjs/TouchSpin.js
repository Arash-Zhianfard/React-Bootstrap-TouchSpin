...
var TouchSpin = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "input-group input-group-" + size },
        ...
        react_1.default.createElement("input", { type: "text", className: "form-control", value: counter.toFixed(decimals), readOnly: true, style: { background: 'white' } }),
