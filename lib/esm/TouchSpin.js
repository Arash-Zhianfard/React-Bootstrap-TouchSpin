...
var TouchSpin = function (_a) {
    var _b = _a.signAlignment, signAlignment = _b === void 0 ? Alignment.Left : _b, sign = _a.sign, _c = _a.initValue, initValue = _c === void 0 ? 0 : _c, _d = _a.step, step = _d === void 0 ? 1 : _d, _e = _a.min, min = _e === void 0 ? 0 : _e, _f = _a.max, max = _f === void 0 ? 10000 : _f, _g = _a.size, size = _g === void 0 ? BsSize.Small : _g, _h = _a.decimals, decimals = _h === void 0 ? 0 : _h;
    var _j = useState(initValue), counter = _j[0], setCounter = _j[1];
    ...
    return (React.createElement("div", { className: "input-group input-group-" + size },
        ...
        React.createElement("input", { type: "text", className: "form-control", value: counter.toFixed(decimals) }),
